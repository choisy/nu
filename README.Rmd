...
where `dir` is the name of the directory on the remote server we want to look at,
`ip` is the IP address of the remote server, `user` is the user name for the SSH
connectionn, and `key` is the path on your local computer to the key for the SSH
connection.
...
where `file` is the name of the file you want to send. This file has to be in
your working directory. `dir` is the name of the directory on the remote server
...
`dir` indicates where you want to run your R session on the remote server. This
...
where `file` is the name of the file of the `dir` directory that you want to
